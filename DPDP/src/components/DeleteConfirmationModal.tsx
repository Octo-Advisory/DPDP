            ...
            <div className="relative w-full max-w-sm rounded-xl bg-white p-6 shadow-2xl ring-1 ring-slate-900/5 sm:max-w-md transform transition-all scale-100">
                <div className="absolute right-4 top-4">
                    <button
                        onClick={onClose}
                        disabled={isDeleting}
                        className="text-slate-400 hover:text-slate-500 disabled:opacity-50 transition-colors"
                    >
                        <X className="h-5 w-5" />
                    </button>
                </div>
                ...
                <div className="mt-6 sm:mt-8 sm:flex sm:flex-row-reverse sm:gap-3">
                    <button
                        ...
                        onClick={onConfirm}
                        disabled={isDeleting}
                        className="inline-flex w-full justify-center rounded-lg bg-red-600 px-4 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-70 disabled:cursor-not-allowed sm:w-auto transition-all"
                    >
